...
router.get('/address-list-add', index_1.DisplayAddressListAddPage);

/* POST Route for processing the Add page - CREATE Operation */
router.post('address-list-add', index_1.ProcessAddressListEditPage);

/* GET Route for displaying the Edit page - UPDATE Operation */
router.get('address-list-edit/:id', index_1.DisplayAddressListEditPage);

/* POST Route for processing the Edit page - UPDATE Operation */
router.post('/address-list-edit/:id', index_1.ProcessAddressListEditPage);

/* GET to perform  Deletion - DELETE Operation */
router.get('/delete/address-list/:id', index_1.performDelete);