...
router.get('/address-list-add', (req, res, next) => {
    res.render('address-list-add', {title: "Add Address"})
});
...
router.get('/edit/:id', (req, res, next) => {
    ...
    if(err)
    {
        ...
        //show the edit view
        res.render('address-list-edit', {title: 'Edit Address', address: addressToEdit})
    }     
    })
});
